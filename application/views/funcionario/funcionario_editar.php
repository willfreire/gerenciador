                                ...
                                <form role="form" name="frm_cad_benef_edit_func" id="frm_cad_benef_edit_func">
                                    ...
                                    <div class="box-body">
                                            ...
                                            <div class="row">
                                                <div class="col-xs-10 col-sm-8 col-md-5 col-lg-4">
                                                    ...
                                                    <div class="controls">
                                                        <div class="input-group">
                                                            <span class="input-group-addon">R$</span>
                                                            <input type="text" class="form-control" id="vl_unitario_edit" name="vl_unitario_edit" placeholder="0,00" maxlength="10" value="0,00" required="true">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                <div class="col-xs-10 col-sm-8 col-md-5 col-lg-4">
                                                    <label for="qtd_dia_edit">Quantidade Unit&aacute;ria<span class="text-danger">*</span></label>
                                                    <div class="controls">
                                    ...
                                    <div class="box-footer">
                                        <input type="hidden" id="id_func" name="id_func" value="<?=$id?>">
                                        <input type="hidden" id="id_benef" name="id_benef" value="">
