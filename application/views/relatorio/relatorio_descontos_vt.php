        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="active">Descontos de VT</li>
                </ol>
            </section>
                ...
                <div class="row">
                    ...
                    <div class="col-xs-12">
                        ...
                        <div class="container-fluid box box-primary" id="box-frm-import">
                            ...
                            <form role="form" name="frm_rel_desc_vt" id="frm_rel_desc_vt">
                                ...
                                <div class="box-footer">
                                    <button type="submit" id="btn_rel_desc" name="btn_rel_desc" class="btn btn-success">Exportar</button>
