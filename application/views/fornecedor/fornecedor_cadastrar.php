                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                                ...
                                                <div class="controls">
                                                    <input type="text" class="form-control" id="nome_fornecedor" name="nome_fornecedor" placeholder="Nome" maxlength="250" required="true" autofocus="true">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="row">
                                            <div class="col-xs-12 col-sm-8 col-md-6 col-lg-5">
                                                ...
                                                <div class="controls">
                                                    ...
                                                    <label class="radio-inline">
                                                        <input type="radio" name="status" id="status" value="2"> Inativo
                                                    </label>
                                                </div>
                                            </div>
                                        </div>
