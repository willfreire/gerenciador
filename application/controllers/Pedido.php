    ...
    public function gerarBoleto($id_pedido = null)
    {
        ...
        if (!empty($pedido)):
            ...
            $boleto = new Santander(array(
                ...
                'logoPath' => base_url('/assets/imgs/logo_vtcards_120x57.jpg'), // Logo da sua empresa - #357CA5
                # 'contaDv'   => 96,
                # 'agenciaDv' => 1,
                ...
                'aceite'               => 'N',
                'especieDoc'           => 'DS',
                'numeroDocumento'      => str_pad(base64_decode($id_pedido), 7, 0, STR_PAD_LEFT),
                # 'usoBanco'             => 'Uso banco',
                # 'layout'               => 'layout.phtml',
    ...
    public function remitirBoletoHtml($id_pedido)
    {
        ...
        if (!empty($row_bol)):
            ...
            $boleto = new Santander(array(
                ...
                'aceite'               => 'N',
                'especieDoc'           => 'DS',
                'numeroDocumento'      => str_pad($id_pedido, 7, 0, STR_PAD_LEFT),
                # 'usoBanco'             => 'Uso banco',
                # 'layout'               => 'layout.phtml',
                # 'logoPath'             => 'http://boletophp.com.br/img/opensource-55x48-t.png',
                # 'sacadorAvalista'      => new Agente('Antônio da Silva', '02.123.123/0001-11'),
