    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                <h1>
                    Relat&oacute;rio de Inconsist&ecirc;ncias
                </h1>
                <ol class="breadcrumb">
                    <li>
                    ...
                    <li class="active">Relat&oacute;rio de Inconsist&ecirc;ncias</li>
                </ol>
            </section>
                ...
                <div class="row">
                    ...
                    <div class="col-xs-12">
                        ...
                        <div class="container-fluid box box-primary" id="box-frm-import">
                            ...
                            <form role="form" name="frm_rel_incons_vt" id="frm_rel_incons_vt">
                                ...
                                <div class="box-footer">
                                    <button type="submit" id="btn_rel_incons" name="btn_rel_incons" class="btn btn-success">Exportar</button>
