                            ...
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                        <label for="resposta">Mensagem<span class="text-danger">*</span></label>
                                        <div class="controls">
                                            <textarea class="form-control" id="resposta" name="resposta" placeholder="Mensagem" maxlength="1000" rows="5" required="true"></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group align_center">
                                        ...
                                        <button type="submit" class="btn btn-success" name="cad_resp" id="alt_status">Enviar</button>
